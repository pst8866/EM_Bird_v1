...
linker.cmd: package/cfg/mcasp_ethernet_pe674.xdl
	$(SED) 's"^\"\(package/cfg/mcasp_ethernet_pe674cfg.cmd\)\"$""\"C:/Users/pagrawal/workspace_v8/McASP_queue_Ethernet/.config/xconfig_mcasp_ethernet/\1\""' package/cfg/mcasp_ethernet_pe674.xdl > $@
